  ...
  return (
    <div className="flex h-screen items-center justify-center bg-slate-900 text-slate-100 font-sans">
      <div className="w-full max-w-md p-8 bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-[200px] h-[200px] bg-cyan-500/20 blur-[80px] rounded-full pointer-events-none"></div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-xl py-3 px-4 text-slate-100 focus:outline-none focus:border-cyan-500 transition-colors"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-medium transition-colors disabled:opacity-50 mt-4 shadow-lg shadow-cyan-900/20"
          >
